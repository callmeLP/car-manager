<?php
  ...
  $sql = "SELECT carowner.carId, carowner.owner, carowner.tel, inoutinf.carNum, carowner.type, carowner.color, carowner.subDepartment, carowner.remark, inoutinf.time, inoutinf.inOrOut FROM carowner right join inoutinf on carowner.carNum = inoutinf.carNum";
